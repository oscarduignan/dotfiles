...
class ModeInsert extends Mode_1.Mode {
        ...
        this.maps = [
            ...
            { keys: 'ctrl+c', actions: [
                    ...
                    () => Selection_1.ActionSelection.shrinkToActives()
                        .then(isShrinked => isShrinked ? Promise.resolve(true) : Mode_2.ActionMode.toNormal()),
                ] },
            { keys: 'ctrl+[', actions: [
                    NativeEscape_1.ActionNativeEscape.press,
                    () => Selection_1.ActionSelection.shrinkToActives()
    ...
    processRecord() {
        ...
        const inputedText = currentLineText.substring(this.recordStartPosition.character - deletionCountBefore, currentLineText.length - (this.recordStartLineText.length - this.recordStartPosition.character - deletionCountAfter));
